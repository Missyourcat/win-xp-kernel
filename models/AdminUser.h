...
class AdminUser
{
  public:
     ...
     */
    explicit AdminUser(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit AdminUser(const Json::Value &pJson) noexcept(false);
     ...
     */
    AdminUser(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<AdminUser>;
    friend drogon::orm::BaseBuilder<AdminUser, true, true>;
    friend drogon::orm::BaseBuilder<AdminUser, true, false>;
    friend drogon::orm::BaseBuilder<AdminUser, false, true>;
    friend drogon::orm::BaseBuilder<AdminUser, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<AdminUser>;
#endif
