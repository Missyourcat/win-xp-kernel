...
class ArticleMd
{
  public:
    struct Cols
    {
        ...
        static const std::string _content_md;
     ...
     */
    explicit ArticleMd(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit ArticleMd(const Json::Value &pJson) noexcept(false);
     ...
     */
    ArticleMd(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    /**  For column content_md  */
    ///Get the value of the column content_md, returns the default value if the column is null
    const std::string &getValueOfContentMd() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getContentMd() const noexcept;
    ///Set the value of the column content_md
    void setContentMd(const std::string &pContentMd) noexcept;
    void setContentMd(std::string &&pContentMd) noexcept;
    ...
    const int64_t &getValueOfViewCount() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<int64_t> &getViewCount() const noexcept;
    ///Set the value of the column view_count
    void setViewCount(const int64_t &pViewCount) noexcept;
  ...
  private:
    friend drogon::orm::Mapper<ArticleMd>;
    friend drogon::orm::BaseBuilder<ArticleMd, true, true>;
    friend drogon::orm::BaseBuilder<ArticleMd, true, false>;
    friend drogon::orm::BaseBuilder<ArticleMd, false, true>;
    friend drogon::orm::BaseBuilder<ArticleMd, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<ArticleMd>;
#endif
    ...
    std::shared_ptr<std::string> contentMd_;
    std::shared_ptr<int8_t> status_;
    std::shared_ptr<int64_t> viewCount_;
