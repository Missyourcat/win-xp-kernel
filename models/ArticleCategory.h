...
class ArticleCategory
{
  public:
     ...
     */
    explicit ArticleCategory(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit ArticleCategory(const Json::Value &pJson) noexcept(false);
     ...
     */
    ArticleCategory(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    ArticleCategory() = default;
  ...
  private:
    friend drogon::orm::Mapper<ArticleCategory>;
    friend drogon::orm::BaseBuilder<ArticleCategory, true, true>;
    friend drogon::orm::BaseBuilder<ArticleCategory, true, false>;
    friend drogon::orm::BaseBuilder<ArticleCategory, false, true>;
    friend drogon::orm::BaseBuilder<ArticleCategory, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<ArticleCategory>;
#endif
